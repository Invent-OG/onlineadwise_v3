...
const HeroSection = () => {
  return (
    <section className="relative container-narrow min-h-screen bg-background overflow-hidden pt-20 md:pt-24">
      {/* Background Effects */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Subtle gold glow at top */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[800px] h-[300px] md:h-[400px] bg-gold/5 rounded-full blur-[80px] md:blur-[120px]" />
        {/* Side accents */}
