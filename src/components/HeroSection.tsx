...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute top-48 right-10 lg:right-40 float-animation opacity-20" style={{ animationDelay: "1s" }}>
        <BarChart3 className="w-10 h-10 text-primary" />
      </div>
      <div className="absolute bottom-32 left-20 float-animation opacity-20" style={{ animationDelay: "2s" }}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/5 mb-8 slide-up">
            ...
            <span className="text-sm font-medium text-primary">Digital Marketing Consultation</span>
          </div>
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-bold leading-tight mb-6 slide-up stagger-1">
            ...
            <br />
            <span className="text-gradient-gold">Psychology</span>
          </h1>
          ...
          <div className="mt-16 slide-up stagger-5">
            <p className="text-sm text-muted-foreground mb-4">Powered by The NAREN Method™ — Created by Narender Sharma</p>
