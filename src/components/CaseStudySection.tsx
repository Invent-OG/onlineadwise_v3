import { TrendingUp, TrendingDown, Phone, Award, Compass, Magnet, Settings, Expand, Repeat } from "lucide-react";
  ...
  const process = [
    {
      letter: "N",
      title: "Navigate",
      description: "Market research, competitor breakdown, HVAC psychology mapping.",
      icon: Compass,
    },
    {
      letter: "A",
      title: "Attract",
      description: "Launched HVAC Commercial Video + Local Service Hooks. Facebook + Google Search campaigns.",
      icon: Magnet,
    },
    {
      letter: "R",
    ...
    },
    {
      letter: "N",
      title: "Normalize",
      description: "Weekly optimization + automation in GHL + missed-call text-back.",
      icon: Repeat,
    },
  ];

  const results = [
    { icon: TrendingUp, value: "74", label: "Booked Appointments", emoji: "📈" },
    { icon: TrendingDown, value: "47%", label: "CPA Reduced", emoji: "📉" },
    { icon: Phone, value: "3X", label: "Increase in Inbound Calls", emoji: "📞" },
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-6">
            ...
            <span className="text-gradient-gold">(USA)</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            🔥 "From Zero Booking System → to 74 Booked Appointments/Month in 42 Days"
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-card/50 backdrop-blur-sm rounded-2xl border border-border/50 p-8 mb-8">
            <h3 className="text-xl font-display font-bold text-foreground mb-6">Challenges</h3>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {challenges.map((challenge, i) => (
                <div key={i} className="flex items-center gap-2 p-3 rounded-xl bg-destructive/10 border border-destructive/20">
          ...
          <div className="bg-card/50 backdrop-blur-sm rounded-2xl border border-border/50 p-8 mb-8">
            ...
            <div className="grid md:grid-cols-5 gap-4">
              {process.map((step) => {
                ...
                return (
                  <div key={step.letter + step.title} className="relative group">
          ...
          <div className="bg-gradient-to-br from-primary/10 to-card rounded-2xl border border-primary/30 p-8 glow-gold-sm">
            <h3 className="text-xl font-display font-bold text-foreground mb-6 text-center">Results</h3>
              ...
              {results.map((result, i) => {
                ...
                return (
                  <div key={i} className="text-center">
                    ...
                    <div className="text-3xl font-display font-bold text-gradient-gold mb-1">{result.value}</div>
