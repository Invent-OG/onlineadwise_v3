...
const smbProblems = [
  ...
  {
    emoji: "⛔",
    title: "Google Keeps Rejecting or Limiting Our Ads",
    symptoms: [
      "Ads disapproved repeatedly",
      "Account restricted",
      "No clear reason from Google",
    ],
...
const ProblemsSection = () => {
  ...
  return (
    <section
      ref={ref}
      id="problems"
      className="section-padding bg-background py-5 relative overflow-hidden"
    >
      {/* Background Glow */}
      <motion.div
        style={{ y }}
        ...
        >
          <div className="emoji-card max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl font-bold text-foreground">
              You're treating Google Ads as a{" "}
