...
const caseStudies = [
  {
    ...
    challenge:
      "Spending $8,000/month on Google Ads with ROAS: 1.8x (Losing money), 72% cart abandonment rate, broken pixel tracking post-iOS 14",
    implementation: [
...
const CaseStudiesSection = () => {
  ...
  return (
    <section id="case-studies" className="section-padding  py-24 bg-card">
      <div className="container">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            See how the NAREN Method has transformed Google Ads performance
            across industries
          </p>
        </motion.div>
