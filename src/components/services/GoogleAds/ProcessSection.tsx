...
const ProcessSection = () => {
  return (
    <section id="process" className="section-padding  py-16 bg-muted">
      <div className="container">
        ...
        >
          <motion.span
            ...
            viewport={{ once: true }}
            className="inline-block bg-primary text-white px-4 py-2 rounded-full text-sm font-semibold mb-4"
          >
            The Process
          </motion.span>
          ...
          {phases.map((phase, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    className={`bg-card rounded-2xl p-6 shadow-md border border-border inline-block ${
