...
const services = [
  {
    ...
    bestFor: "Businesses starting Google Ads or rebuilding broken accounts",
  },
  {
    icon: Palette,
    title: "Creative Production & Testing",
    description:
      "Search ads, Display banners, YouTube ads, Performance Max, Discovery ads",
  ...
  },
  {
    ...
    description:
      "Merchant Center setup, product feed optimization, Shopping campaigns, PMax for Retail",
  ...
  },
  {
    ...
    description:
      "Search Lead Forms, YouTube for Action, landing page conversion funnels",
  ...
  },
  {
    ...
    bestFor: "Digital marketing agencies scaling Google Ads",
  },
  {
    icon: Search,
      ...
      <div className="container">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Everything You Need to Dominate Google Search, Youtube & Display
            Advertising
          </p>
        </motion.div>
