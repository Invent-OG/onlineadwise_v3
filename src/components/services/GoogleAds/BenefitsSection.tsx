...
const benefits = [
  {
    icon: Award,
    title: "Google Ads Certified Expert",
    description:
      "7+ years specializing ONLY in Google Search & Display Ads—not a generalist dabbling across 10 platforms.",
  },
  {
    icon: DollarSign,
  ...
  },
  {
    ...
    description:
      "Most 'Google Ads experts' can't code. I implement server-side tracking, custom events, and attribution models.",
  },
  {
    icon: Handshake,
    title: "White-Label Partnership Available",
    description:
      "Agency owners: Scale Google Ads without hiring. I stay in the background, you keep the client relationship.",
  },
  {
    icon: Clock,
...
const BenefitsSection = () => {
  return (
    <section
      id="benefits"
      className="section-padding container py-16 bg-background"
    >
      <div className="container">
        ...
        >
          <motion.span
            ...
            viewport={{ once: true }}
            className="inline-block bg-primary text-secondary px-4 py-2 rounded-full text-sm font-semibold mb-4"
          >
            Why Choose Me
          </motion.span>
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
            Why Choose Narender Sharma for Google Ads?
          </h2>
