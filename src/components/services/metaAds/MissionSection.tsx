        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              Facebook Ads systems that transform ad spend from unpredictable
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed">
              To become the go-to Facebook Ads partner for growth-focused SMBs
              and agencies across the globe. We envision a world where
              businesses no longer fear Facebook Ads, but embrace them as their
              most reliable customer acquisition channel—backed by systems,
              data, and expertise.
            </p>
          </motion.div>
        </div>
