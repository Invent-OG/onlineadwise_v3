  ...
  const stages = [
    {
      ...
      description: "Before touching ads, we study your industry, customer psychology, funnel gaps, and data accuracy.",
      points: [
      ...
      outcome: "You know exactly what to do, why you're doing it, and where growth is blocked.",
    },
    {
      letter: "A",
      title: "Attract",
      ...
      description: "We craft attention-pulling assets using proven persuasion triggers and deploy across all major platforms.",
      points: [
    ...
    },
    {
      ...
      description: "Behavior analysis + funnel forensics to optimize every touchpoint in your customer journey.",
      points: [
        "Heatmap study",
        "Drop-off detection",
      ...
      outcome: "Lower CPL, stronger conversions, cleaner data, profitable performance.",
    },
    {
      letter: "E",
      title: "Expand",
      ...
      description: "We scale psychologically and structurally for sustainable growth with predictable ROI.",
      points: [
        "Multi-geo expansion",
        "Budget scaling",
        "Offer variations",
    ...
    },
    {
      ...
      icon: Repeat,
      color: "from-primary to-accent",
      description: "Your business now runs on a system — not luck. Marketing becomes stable and reliable.",
      points: [
        "Weekly audits",
        "Creative rotation",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A 5-stage behavioral + performance system that ensures consistent, sustainable, high-quality leads — not just inconsistent spikes.
          </p>
        </div>
                ...
                <div className="relative p-6 md:p-8">
                  <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                    ...
                    <div className="flex items-center gap-4 lg:w-48 shrink-0">
                      <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${stage.color} flex items-center justify-center text-3xl font-display font-bold text-white glow-gold-sm`}>
                        {stage.letter}
                      </div>
                      <div>
                        <h3 className="text-xl font-display font-bold text-foreground">{stage.title}</h3>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/10 border border-primary/20">
                        ...
                        <span className="text-sm text-foreground">{stage.outcome}</span>
                      </div>
                    </div>
                  </div>
                </div>
